...
/// Live AI Pose Detection Screen displaying 33 MediaPipe Body Landmarks & FPS metrics with interactive motion tracking.
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: GestureDetector(
        onPanUpdate: (details) {
          final dx = (details.localPosition.dx / screenSize.width) - 0.5;
          final dy = (details.localPosition.dy / screenSize.height) - 0.5;
          poseNotifier.updateMotionOffset(dx, dy);
        },
        child: Stack(
          fit: StackFit.expand,
          children: [
